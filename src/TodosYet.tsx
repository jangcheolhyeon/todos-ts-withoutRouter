                ...
                return (
                    <div key={index}>
                        ...
                        <div className='btns'>
                            ...
                            <label htmlFor='deleteBtn' style={{ padding : "10px", cursor: "pointer", marginRight: "5px" }}><FontAwesomeIcon icon={faTrash} /></label>
                            {element.isEditing ? 
                            (
                                <>
                                    <input type="button" id="completeBtn" onClick={() => onCompleteBtn(element)} />
                                    <label htmlFor='completeBtn' style={{ padding : "10px", cursor: "pointer" }} ><FontAwesomeIcon icon={faPen} /></label>
                                </>
                            ) : (
                                <>
                                    <input type="button" id='updateBtn' onClick={() => onUpdateBtn(element)} /> 
                                    <label htmlFor='updateBtn' style={{ padding : "10px", cursor: "pointer" }} ><FontAwesomeIcon icon={faPen} /></label>
                                </>
                            )
                            }
                        </div>
